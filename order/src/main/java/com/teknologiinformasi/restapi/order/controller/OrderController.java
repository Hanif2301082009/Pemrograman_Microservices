...
private RestTemplate restTemplate;
   ...
   public ResponseEntity<?> getOrderById(@PathVariable Long id) {
        ...
        String productServiceUrl = "http://192.168.21.2:8080/api/produk/" + order.getProductId();
...
//     // Validasi keberadaan produk dengan memanggil Product Service
//     String productServiceUrl = "http://192.168.21.2:8080/api/produk/" + order.getProductId();
//     try {
//         Produk product = restTemplate.getForObject(productServiceUrl, Produk.class);
...
//         return ResponseEntity.status(HttpStatus.NOT_FOUND).body("Product not found");
//     } catch (Exception e) {
//         return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("Error connecting to Product Service");
//     }

//     // Jika produk valid, lanjutkan pembuatan order
